...
MP_INVALID( Cpl::Dm::Mp::Bool, buttonEventMode );
MP_INVALID( Cpl::Dm::Mp::Bool, buttonEventFan );
MP_INVALID( Cpl::Dm::Mp::Bool, buttonEventUp );
MP_INVALID( Cpl::Dm::Mp::Bool, buttonEventDown );
