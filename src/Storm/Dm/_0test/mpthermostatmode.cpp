...
#define INITIAL_VALUE       Storm::Type::ThermostatMode::eAUTO
...
static MpThermostatMode       mp_apple_( modelDb_, "APPLE" );
static MpThermostatMode       mp_orange_( modelDb_, "ORANGE", INITIAL_VALUE );
...
TEST_CASE( "MpThermostatMode" )
{
    ...
    bool truncated;
    bool valid;
    Storm::Type::ThermostatMode value = Storm::Type::ThermostatMode::eHEATING;
    ...
    SECTION( "read/writes" )
    {
        mp_apple_.write( Storm::Type::ThermostatMode::eHEATING );
        valid = mp_apple_.read( value );
        REQUIRE( valid );
        REQUIRE( value == +Storm::Type::ThermostatMode::eHEATING );
        mp_apple_.write( Storm::Type::ThermostatMode::eAUTO );
        valid = mp_apple_.read( value );
        REQUIRE( valid );
    ...
    SECTION( "toJSON-pretty" )
    {
        ...
        REQUIRE( STRCMP( doc["val"], (+Storm::Type::ThermostatMode::eAUTO)._to_string() ) );
    }
