...
public:
    ...
    inline bool readAndSync( Storm::Type::CycleInfo_T& dstData, Cpl::Dm::SubscriberApi& observerToSync )
    {
        return ModelPointCommon_::readAndSync( &dstData, sizeof( Storm::Type::CycleInfo_T ), observerToSync );
    }
