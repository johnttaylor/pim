...
public:
    ...
    inline bool readAndSync( Storm::Type::HvacRelayOutputs_T& dstData, Cpl::Dm::SubscriberApi& observerToSync )
    {
        return ModelPointCommon_::readAndSync( &dstData, sizeof( Storm::Type::HvacRelayOutputs_T ), observerToSync );
    }
