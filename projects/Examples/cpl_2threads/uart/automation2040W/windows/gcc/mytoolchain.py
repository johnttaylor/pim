...
common_flags           = f' {wifi_flags} -DPICO_HEAP_SIZE=4096 -DPICO_STACK_SIZE=2048 -DPICO_CORE1_STACK_SIZE=2048 -DPICO_COPY_TO_RAM=0 -DPICO_CXX_ENABLE_EXCEPTIONS=0 -DPICO_NO_FLASH=0 -DPICO_NO_HARDWARE=0 -DPICO_ON_DEVICE=1 -DPICO_USE_BLOCKED_RAM=0 '
