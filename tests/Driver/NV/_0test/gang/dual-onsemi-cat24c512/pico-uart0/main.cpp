...
#ifndef OPTION_I2C_DEV_ADDRESS2
#define OPTION_I2C_DEV_ADDRESS2  0x51
#endif

static Driver::I2C::RP2040::Master          i2cBus0Driver_( OPTION_I2C_DEVICE, OPTION_I2C_BAUDRATE, OPTION_I2C_TIMEOUT );
static Driver::NV::Onsemi::CAT24C512::Api   eeprom1_( i2cBus0Driver_, OPTION_I2C_DEV_ADDRESS );
static Driver::NV::Onsemi::CAT24C512::Api   eeprom2_( i2cBus0Driver_, OPTION_I2C_DEV_ADDRESS2 );
static Driver::NV::Api*                     drivers_[] ={ &eeprom1_, &eeprom2_, 0 };
...
int main(void)
{
    ...
    runtests( uut_, 
              OPTION_DRIVER_NV_ONSEMI_CAT24C512_NUM_PAGES*2, 
              OPTION_DRIVER_NV_ONSEMI_CAT24C512_BYTES_PER_PAGE,
              OPTION_DRIVER_NV_ONSEMI_CAT24C512_NUM_PAGES * OPTION_DRIVER_NV_ONSEMI_CAT24C512_BYTES_PER_PAGE * 2
    );
